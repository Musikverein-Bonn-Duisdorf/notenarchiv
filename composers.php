...
$chunk = listChunkComposers(0, 50, 'name', 'asc');
...
<div id="Liste">
<?php echo $chunk['html']; ?>
<?php echo listChunkRenderSentinel('composers', $chunk['nextCursor'], $chunk['hasMore'], 'filterPieces', ' data-sort="name" data-dir="asc"'); ?>
</div>
<?php
adminListPageEnd();
?>
