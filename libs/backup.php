<?php
/**
 * Database backup / restore helpers (ARCHIV-2; Melde-Parität MELD-90/131/132).
 *
 * Dumps only tables matching $dbprefix (archiv_*). Never touches identity
 * tables under $identityPrefix (meldeliste_*).
 */
