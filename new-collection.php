    ...
    <div class="profile-hero-actions">
      <div class="profile-actions">
        <div class="profile-actions-primary">
          ...
          <?php echo $backLink; ?>
<?php if($isEdit) {
    $delConfirm = ($delName !== '' ? 'Soll „'.$delName.'“ gelöscht werden?' : 'Soll diese Sammlung gelöscht werden?');
    echo archivDeleteAction(
        'archivDelCollection'.(int)$entity->Index,
        $delConfirm,
...
<form id="archivEntityEditForm" class="profile-form" action="new-collection.php" method="POST">
<?php if($isEdit) { ?>
