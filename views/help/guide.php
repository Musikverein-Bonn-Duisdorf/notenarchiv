...
$sections[] = array(
    ...
    'body' => '
<p><b>Komponisten</b> und <b>Verlage</b> sind Stammdaten für den Katalog (Sortierung und Nachladen wie bei den Stücken). Anlegen geht über die jeweiligen Anlege-Seiten (<b>Admin → Komponist</b> / <b>Verlag</b> oder Plus in der Liste) sowie schnell beim Stück per Plus. Ein Stück kann mehrere Komponisten und Arrangeure haben (Chip-Felder; Reihenfolge = Anzeige). Verlage können Website und Logo haben. Stücke können eine <b>Produktseite</b> (konkrete Verlags-URL) haben; der Verlagsname verlinkt dorthin bzw. auf die Verlags-Website. Ein Klick in der Liste öffnet ein Detail-Modal; <b>Bearbeiten</b> führt auf die Anlege-Seite (dort auch Löschen und Foto).</p>
'
);
